...
public class DbHelper extends SQLiteOpenHelper {
	...
	// Database Name
	private static final String DATABASE_NAME = "ictQuiz";
	// tasks table name
	...
	private static final String KEY_OPTD= "optd"; //option d .. added..May.14.2014.
	private static final String KEY_HINT= "hint"; //hint added ..May.14.2014.
