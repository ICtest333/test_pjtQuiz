...
public class DatabaseAdapter {
	...
	static final String QUIZ_CONTENT = "content";
	//컬럼 인덱스
	static final int ID_INDEX = 0;
	static final int CONTENT_INDEX = 1;
	//컬럼 명세
	static final String[] PROJECTION = new String[]{QUIZ_ID,QUIZ_CONTENT};
	//테이블 생성 SQL
	static final String CREATE_TABLE = "CREATE table "+ TABLE_NAME + "(" + QUIZ_ID + " integer primary key autoincrement, " + QUIZ_CONTENT + " text not null)";
	//테이블 삭제 SQL
